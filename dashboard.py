...
# komponen filter dengan widget date input serta menambahkan logo perusahaan pada sidebar
...
# menampilkan total order dan revenue dalam bentuk metric() menggunakan layout columns()
...
# performa penjualan dari setiap produk. 
